...
public class AppointmentService {
	...
	public String insertAppointment(@FormParam("doctorid") String doctorid, @FormParam("doctorName") String doctorName,
			@FormParam("patientid") int patientid, @FormParam("patientName") String patientName,
			@FormParam("hospitalName") String hospitalName, @FormParam("date") String date) {
		String output = appointmentObj.insertAppointment(doctorid, doctorName, patientid, patientName, hospitalName, date);
		return output;
	}
...
//Read the values from the JSON object
		...
		String output = appointmentObj.updateAppointment(appointmentid, doctorid, doctorName, patientid, patientName, hospitalName, date);
		return output;
	}
...
//Read the value from the element <itemID>
		...
		String output = appointmentObj.deleteAppointment(doctorid);
		return output;
	}
}
